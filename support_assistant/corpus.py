...
DOCS = {
    ...
    "doc_03.txt": (
        ...
        "to limited-time deals 24 hours before they go live to Basic and Pass members). "
    ...
    "doc_04.txt": (
        ...
        "status shows no movement for more than 20 minutes past its original estimated "
        "delivery time, customers should contact support directly rather than continue "
        "waiting, since this indicates a likely delivery issue."
    ),
    ...
    "doc_05.txt": (
        ...
        "Zepto's quick-delivery model. If a packed order cannot be delivered due to "
    ...
    "doc_06.txt": (
        ...
        "on the order page. Zepto ships a free replacement or issues a full refund "
        "for damaged, spoiled, or missing items without requiring the customer to "
        "return the original item, unless the order value exceeds INR 1000, in which "
        "case a photo of the issue must be submitted through the report form before "
        "a replacement or refund is processed."
    ),
    ...
    "doc_07.txt": (
        ...
        "no maintenance fees. Gift card balance can be combined with one other payment "
    ...
    "doc_08.txt": (
        "Zepto customer support is available via in-app chat 24 hours a day, 7 days "
        "a week, given the time-sensitive nature of quick commerce deliveries. "
